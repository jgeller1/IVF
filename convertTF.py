""" 
Converts training images to .tfRecords to be used in 
model training. Modified from STORK.
"""
...
sys.path.append("datasets") #add the "datasets" directory from "slim" to the system path
...
if __name__ == '__main__':
  ...
  """
  INPUT_IMAGES_TRAIN_DIR = '/Users/jaredgeller/Desktop/IVF/Images/train'
  TRAIN_IMAGES_TFRecordFiles = '/Users/jaredgeller/Desktop/IVF/TrainedTFRecord'
  buildTfRecordFile(INPUT_IMAGES_TRAIN_DIR, TRAIN_IMAGES_TFRecordFiles)
